...
class Connectivity {
  ...
  // Check download speed bps, mbps, kbps
  ...
  // Validate parameters before the function call
...
const connTest = new Connectivity();
module.exports = connTest;
